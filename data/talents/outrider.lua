...
newTalentType{ allow_random=true, type="mounted/disobedience", name = "disobedience", description = "Commanding wild beasts requires a strong will and a steady hand; without these, you look just as much like prey as any of your enemies."}
...
newTalentType{ allow_random=true, type="mounted/skirmish-tactics", name = "skirmish tactics", description = "Atop your beast, not even the winds can outpace you, nor the sky outreach your aim."}
